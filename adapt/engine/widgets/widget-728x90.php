<?php
class DT_Ads_728x90 extends WP_Widget {

	function DT_Ads_728x90(){
		$widget_ops = array( 'classname' => 'DT_Ads_728x90', 'description' => 'Display 728x90 banner ads with rotate option' );
		$control_ops = array('width' => 350, 'height' => 350);
		$this->WP_Widget( 'dt_ads-728', 'DT - Ads 728x90', $widget_ops, $control_ops );
	}
