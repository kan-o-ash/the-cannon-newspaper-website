<?php
class DT_Ads_300x250 extends WP_Widget {

	function DT_Ads_300x250(){
		$widget_ops = array( 'classname' => 'DT_Ads_300x250', 'description' => 'Display 300x250 banner ads with rotate option' );
		$control_ops = array('width' => 350, 'height' => 350);
		$this->WP_Widget( 'dt_ads-300', 'DT - Ads 300x250', $widget_ops, $control_ops );
	}
